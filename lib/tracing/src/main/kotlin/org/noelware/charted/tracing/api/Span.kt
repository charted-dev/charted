...
/**
 * Represents a transaction span, which can include external metadata about a transaction.
 */
interface Span {
     ...
     * @return a [span event][Event] spawned.
     */
    fun startEvent(description: String, metadata: Map<String, Any>): Event
