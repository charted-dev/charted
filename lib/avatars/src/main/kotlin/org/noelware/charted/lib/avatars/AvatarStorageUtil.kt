...
/**
 * Auxiliary utility to handle avatar storage.
 */
class AvatarStorageUtil(
    private val storage: StorageWrapper,
    private val gravatar: GravatarAvatarFetcher,
    private val identicon: IdenticonAvatarFetcher
) {
    private val log by logging<AvatarStorageUtil>()
