...
docker {
    addDockerfile(Dockerfile(
        ...
        mapOf(),
        listOf(
            "docker.noelware.org/charted/migrations:${semver.major}-amd64",
            "docker.noelware.org/charted/migrations:${semver.major}.${semver.minor}-amd64",
            "docker.noelware.org/charted/migrations:${semver.major}.${semver.minor}.${semver.patch}-amd64",
