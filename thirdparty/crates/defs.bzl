...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.syn-2.0.42.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crate_index__syn-2.0.42", is_dev_dep = False),
