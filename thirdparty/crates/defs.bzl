...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crate_index__serde-1.0.190",
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.serde-1.0.190.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__serde_derive-1.0.190",
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.serde_derive-1.0.190.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.serde_json-1.0.107.bazel"),
    )
