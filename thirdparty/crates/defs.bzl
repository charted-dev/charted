...
_NORMAL_DEPENDENCIES = {
    ...
    "crates/common": {
        _COMMON_CONDITION: {
            ...
            "serde_json": "@crate_index__serde_json-1.0.108//:serde_json",
            "sqlx": "@crate_index__sqlx-0.7.3//:sqlx",
            "thiserror": "@crate_index__thiserror-1.0.52//:thiserror",
            "tracing": "@crate_index__tracing-0.1.40//:tracing",
            "utoipa": "@crate_index__utoipa-4.1.0//:utoipa",
    ...
    "crates/openapi/proc-macro": {
        _COMMON_CONDITION: {
            ...
            "syn": "@crate_index__syn-2.0.43//:syn",
        },
    },
    "crates/proc-macros": {
        _COMMON_CONDITION: {
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crate_index__aws-credential-types-1.1.1",
        sha256 = "70a1629320d319dc715c6189b172349186557e209d2a7b893ff3d14efd33a47c",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-credential-types/1.1.1/download"],
        strip_prefix = "aws-credential-types-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-credential-types-1.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-http-0.60.1",
        sha256 = "30e4199d5d62ab09be6a64650c06cc5c4aa45806fed4c74bc4a5c8eaf039a6fa",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-http/0.60.1/download"],
        strip_prefix = "aws-http-0.60.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-http-0.60.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-runtime-1.1.1",
        sha256 = "87116d357c905b53f1828d15366363fd27b330a0393cbef349e653f686d36bad",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-runtime/1.1.1/download"],
        strip_prefix = "aws-runtime-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-runtime-1.1.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__aws-sigv4-1.1.1",
        sha256 = "d222297ca90209dc62245f0a490355795f29de362eb5c19caea4f7f55fe69078",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-sigv4/1.1.1/download"],
        strip_prefix = "aws-sigv4-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-sigv4-1.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-async-1.1.1",
        sha256 = "1e9f65000917e3aa94c259d67fe01fa9e4cd456187d026067d642436e6311a81",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-async/1.1.1/download"],
        strip_prefix = "aws-smithy-async-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-async-1.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-checksums-0.60.1",
        sha256 = "4c2a63681f82fb85ca58d566534b7dc619c782fee0c61c1aa51e2b560c21cb4f",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-checksums/0.60.1/download"],
        strip_prefix = "aws-smithy-checksums-0.60.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-checksums-0.60.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-eventstream-0.60.1",
        sha256 = "a85e16fa903c70c49ab3785e5f4ac2ad2171b36e0616f321011fa57962404bb6",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-eventstream/0.60.1/download"],
        strip_prefix = "aws-smithy-eventstream-0.60.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-eventstream-0.60.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-http-0.60.1",
        sha256 = "e4e816425a6b9caea4929ac97d0cb33674849bd5f0086418abc0d02c63f7a1bf",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-http/0.60.1/download"],
        strip_prefix = "aws-smithy-http-0.60.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-http-0.60.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-json-0.60.1",
        sha256 = "8ab3f6d49e08df2f8d05e1bb5b68998e1e67b76054d3c43e7b954becb9a5e9ac",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-json/0.60.1/download"],
        strip_prefix = "aws-smithy-json-0.60.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-json-0.60.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__aws-smithy-runtime-1.1.1",
        sha256 = "8da5b0a3617390e769576321816112f711c13d7e1114685e022505cf51fe5e48",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-runtime/1.1.1/download"],
        strip_prefix = "aws-smithy-runtime-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-runtime-1.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-runtime-api-1.1.1",
        sha256 = "2404c9eb08bfe9af255945254d9afc69a367b7ee008b8db75c05e3bca485fc65",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-runtime-api/1.1.1/download"],
        strip_prefix = "aws-smithy-runtime-api-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-runtime-api-1.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-types-1.1.1",
        sha256 = "2aba8136605d14ac88f57dc3a693a9f8a4eab4a3f52bc03ff13746f0cd704e97",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-types/1.1.1/download"],
        strip_prefix = "aws-smithy-types-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-types-1.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-smithy-xml-0.60.1",
        sha256 = "2e8f03926587fc881b12b102048bb04305bf7fb8c83e776f0ccc51eaa2378263",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-smithy-xml/0.60.1/download"],
        strip_prefix = "aws-smithy-xml-0.60.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-smithy-xml-0.60.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__aws-types-1.1.1",
        sha256 = "4e5d5ee29077e0fcd5ddd0c227b521a33aaf02434b7cdba1c55eec5c1f18ac47",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-types/1.1.1/download"],
        strip_prefix = "aws-types-1.1.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-types-1.1.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__clap_complete-4.4.5",
        sha256 = "a51919c5608a32e34ea1d6be321ad070065e17613e168c5b6977024290f2630b",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/clap_complete/4.4.5/download"],
        strip_prefix = "clap_complete-4.4.5",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.clap_complete-4.4.5.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__eyre-0.6.11",
        sha256 = "b6267a1fa6f59179ea4afc8e50fd8612a3cc60bc858f786ff877a4a8cb042799",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/eyre/0.6.11/download"],
        strip_prefix = "eyre-0.6.11",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.eyre-0.6.11.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.futures-channel-0.3.30.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.futures-core-0.3.30.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.futures-io-0.3.30.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.futures-macro-0.3.30.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.futures-sink-0.3.30.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.futures-task-0.3.30.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.futures-util-0.3.30.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.regex-lite-0.1.5.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__reqwest-0.11.23",
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.reqwest-0.11.23.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__serde_yaml-0.9.29",
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.serde_yaml-0.9.29.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.syn-2.0.43.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__thiserror-1.0.52",
        sha256 = "83a48fd946b02c0a526b2e9481c8e2a17755e47039164a86c4070446e3a4614d",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/thiserror/1.0.52/download"],
        strip_prefix = "thiserror-1.0.52",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.thiserror-1.0.52.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__thiserror-impl-1.0.52",
        sha256 = "e7fbe9b594d6568a6a1443250a7e67d80b74e1e96f6d1715e1e21cc1888291d3",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/thiserror-impl/1.0.52/download"],
        strip_prefix = "thiserror-impl-1.0.52",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.thiserror-impl-1.0.52.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/tokio/1.35.1/download"],
        strip_prefix = "tokio-1.35.1",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.tokio-1.35.1.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crate_index__futures-util-0.3.30", is_dev_dep = False),
        ...
        struct(repo = "crate_index__reqwest-0.11.23", is_dev_dep = False),
        ...
        struct(repo = "crate_index__serde_yaml-0.9.29", is_dev_dep = False),
        ...
        struct(repo = "crate_index__syn-2.0.43", is_dev_dep = False),
        struct(repo = "crate_index__sysinfo-0.29.11", is_dev_dep = False),
        struct(repo = "crate_index__tar-0.4.40", is_dev_dep = False),
        struct(repo = "crate_index__thiserror-1.0.52", is_dev_dep = False),
        struct(repo = "crate_index__tokio-1.35.1", is_dev_dep = False),
