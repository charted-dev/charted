...
_NORMAL_DEPENDENCIES = {
    "cli": {
        _COMMON_CONDITION: {
            ...
            "clap": "@crate_index__clap-4.4.9//:clap",
    ...
    "crates/config": {
        _COMMON_CONDITION: {
            "aws-sdk-s3": "@crate_index__aws-sdk-s3-1.2.0//:aws_sdk_s3",
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crate_index__aws-sdk-s3-1.2.0",
        sha256 = "2a995f3cbbfaac2744bf6f1746693cb9260029b7787c29b0103a7be32095cacd",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/aws-sdk-s3/1.2.0/download"],
        strip_prefix = "aws-sdk-s3-1.2.0",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.aws-sdk-s3-1.2.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__clap-4.4.9",
        sha256 = "46ca43acc1b21c6cc2d1d3129c19e323a613935b5bc28fb3b33b5b2e5fb00030",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/clap/4.4.9/download"],
        strip_prefix = "clap-4.4.9",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.clap-4.4.9.bazel"),
    )

    maybe(
        http_archive,
        name = "crate_index__clap_builder-4.4.9",
        sha256 = "63361bae7eef3771745f02d8d892bec2fee5f6e34af316ba556e7f97a7069ff1",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/clap_builder/4.4.9/download"],
        strip_prefix = "clap_builder-4.4.9",
        build_file = Label("@org_noelware_charted_server//thirdparty/crates:BUILD.clap_builder-4.4.9.bazel"),
    )
