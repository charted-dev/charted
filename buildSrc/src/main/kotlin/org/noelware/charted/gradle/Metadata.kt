...
/**
 * Returns the Java compiler version to used to compile **charted-server**
 */
val JAVA_VERSION = JavaVersion.VERSION_17

/**
 * Returns the current Git commit hash of the [charted-dev/charted](https://github.com/charted-dev/charted)
 * repository.
 */
