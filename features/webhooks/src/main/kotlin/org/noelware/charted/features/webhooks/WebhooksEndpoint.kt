...
class WebhooksEndpoint: AbstractEndpoint("/webhooks") {
    @Get
    suspend fun main(call: ApplicationCall) {
        call.respond(
            ...
            buildJsonObject {
                put("success", true)
                putJsonObject("data") {
                    put("message", "Welcome to the Webhooks API!")
                    put("docs_uri", "https://charts.noelware.org/docs/server/features/webhooks")
                }
            }
        )
    }
