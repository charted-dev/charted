...
class RepositoryWebhooksEndpoints: AbstractEndpoint("/repositories/{idOrName}/webhooks") {
    companion object {
        /**
         * Transforms the [RepositoryWebhooksEndpoints] with the necessary data that is applicable
