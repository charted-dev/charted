...
class UserAvatarsEndpoint: AbstractEndpoint("/users/{idOrName}/avatars") {
    companion object {
        /**
         * Transforms the [users avatars endpoints][UserAvatarsEndpoint] with the necessary data that is applicable
