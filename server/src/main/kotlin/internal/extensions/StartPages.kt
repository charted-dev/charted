package org.noelware.charted.server.internal.extensions
...
fun StatusPagesConfig.configure(config: Config) {
    ...
    exception<MultiValidationException> { call, cause ->
        ...
        log.error("Received multiple validation exceptions on REST handler [${call.request.httpMethod.value} ${call.request.path()}]")
        call.respond(
