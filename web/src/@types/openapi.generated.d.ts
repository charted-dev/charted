...
// This file was generated by `bun generate:openapi` at 2024-01-27T03:52:26.250Z
...
export interface paths {
    ...
    '/users/@me/avatar': {
         ...
         */
        get: operations['get_self_user_avatar'];
    ...
    '/users/@me/avatar/{hash}': {
        ...
        get: operations['get_self_user_avatar_by_hash'];
    };
    '/users/{idOrName}': {
    ...
    '/users/{idOrName}/avatar/{hash}': {
        ...
        get: operations['get_user_avatar_by_hash'];
    };
    '/v1': {
        /** @description Main entrypoint to charted-server. This is just a generic "hello world" response. */
        get: operations['main'];
