...
private val FLAGS = mapOf(
    "premium" to (1 shl 0).toLong(), // only available on charts.noelware.org
    "employee" to (1 shl 1).toLong(), // only available on charts.noelware.org
    "verified:publisher" to (1 shl 2).toLong(),
    "admin" to (1 shl 3).toLong()
)
