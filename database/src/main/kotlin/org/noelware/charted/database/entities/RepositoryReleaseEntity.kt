...
import org.noelware.charted.database.tables.RepositoryReleasesTable
...
class RepositoryReleaseEntity(id: EntityID<Long>): LongEntity(id) {
    ...
    var createdAt by RepositoryReleasesTable.createdAt
    var updatedAt by RepositoryReleasesTable.updatedAt
    var tag by RepositoryReleasesTable.tag
}
