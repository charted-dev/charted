...
COPY distribution/docker/scripts /app/charted/server/scripts
...
RUN chmod +x /app/charted/server/scripts/docker-entrypoint.sh /app/charted/server/scripts/run.sh
