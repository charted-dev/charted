...
class NameError extends Error {
  ...
  constructor(kind, message, extra = {}) {
    assert(
      Object.values(NameErrorKind).includes(kind),
      "unknown NameError kind",
    );
    super(`[${kind}]: ${message}`);
   ...
   */
  getExtraCharacters() {
    return this.isExceededMaximumAmount() &&
      utils.hasOwnProperty(this.#extra, "over")
      ? this.#extra.over
      : -1;
  }
   ...
   */
  getIndex() {
    return this.isInvalidInput() && utils.hasOwnProperty(this.#extra, "at")
      ? this.#extra.at
      : -1;
  }
   ...
   */
  getCharacter() {
    return this.isInvalidInput() && utils.hasOwnProperty(this.#extra, "ch")
      ? this.#extra.ch
      : null;
  }
}
